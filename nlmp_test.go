...
func TestUsernameDomainWorkstation(t *testing.T) {
	...
	tables := []struct {
		...
		{"username without domain and non-empty workstation", username, workstation, username, "", []byte{0x4e, 0x54, 0x4c, 0x4d, 0x53, 0x53, 0x50, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x20,
